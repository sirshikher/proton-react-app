...
function (_Component) {
  ...
  function TouchableOpacity() {
    ...
    _defineProperty(_assertThisInitialized(_this), "state", {
      backgroundColor: _this._getChildStyleOpacityWithDefault()
    });
  ...
  _createClass(TouchableOpacity, [{
    ...
    value: function onDown() {
      ...
      this.setState({
        backgroundColor: (0, _color["default"])(this.props.style.backgroundColor).alpha(this.props.activeOpacity).string()
      });
    }
  }, {
    key: "onUp",
    ...
    value: function render() {
      ...
      return _react["default"].createElement(_.View, _extends({}, this.props, {
        style: _objectSpread({}, this.props.style, {}, this.state),
...
_defineProperty(TouchableOpacity, "propTypes", {
