...
var _default = function _default(p) {
  ...
  var element = new _qt.TextInputElement(p.multiline);

  var props = _objectSpread({}, p);

  props = (0, _propChecker["default"])(props, propTypes, defaultProps, 'TextInput');
  var yogaProps = (0, _YogaComponent.YogaComponent)(element, undefined, true);
  var handlers = {
    onChangeText: props.onChangeText
  };
  element.textChangedEvent(function (text) {
  ...
  var updateProps = (0, _propsUpdater["default"])([handlers, 'onChangeText'], {
