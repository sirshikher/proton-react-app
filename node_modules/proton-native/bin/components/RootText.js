...
var _TextFuncs = require("./TextFuncs");
...
var _default = function _default(p) {
  ...
  var element = new _qt.TextElement();

  var props = _objectSpread({}, p);

  props = (0, _propChecker["default"])(props, propTypes, defaultProps, 'Text');
  var styleProp = {
    s: props.style
  };
  ...
  var textProps = (0, _TextFuncs.TextFuncs)(function (text) {
    element.setText(text);
    yogaProps.node.markDirty();
    yogaProps.f.f && yogaProps.f.f();
  }, styleProp.s);
  updateProps(props);
  return _objectSpread({}, textProps, {}, yogaProps, {
    element: element,
